...
void Grid2D::run()
{
    ...
    */
    ...
    glBindImageTexture(0, cellTypeTex, 0, GL_FALSE, 0, GL_READ_WRITE, GL_R8UI);
    ...
    //
    m_addForcesShader->setFloat("vAccelelerations", 9.8f);
    ...
    glBindImageTexture(2, cellTypeTex, 0, GL_FALSE, 0, GL_READ_ONLY, GL_R8UI);
